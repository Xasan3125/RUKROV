    ...
    >
      ...
      <div class="flex justify-between">
        <app-button
          ...
          ><-</app-button
        >
        <app-button v-if="activeSection" @click="toggleOpen" class="w-10"
          >×</app-button
        >
      </div>
      <!-- Зона меню / контента -->
      ...
      >
        <!-- Меню навигации -->
        <div
          v-if="!activeSection && useAppMenu.isOpen"
        ...
        >
          ...
          <div v-else-if="activeSection === 'contacts'">
...
const containerClass = computed(() => {
  ...
  if (activeSection.value){
    if(activeSection.value === 'contacts') {
      return "w-full md:max-w-[400px] max-h-[400px] pb-4 pt-4 px-4  bg-white text-white shadow-[0px_1px_26px_1px_rgba(34,60,80,0.28)]";
    }
